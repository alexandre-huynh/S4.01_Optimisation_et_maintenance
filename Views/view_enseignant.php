    ...
    <!-- Page content -->
          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
                <div class="col-8">
                  <h3 class="mb-0">Liste des stages réalisés par les étudiants</h3>
                </div>
                <div><a href="?controller=enseignant&action=accueil_enseignant&niveau=2">>> Accéder à l'interface classique : liste de tous les documents</a></div>
                <div><a href="?controller=enseignant&action=accueil_enseignant2&niveau=2"><?php if (!isset($_GET["niveau"]) || $_GET["niveau"]==2) : ?>>><?php endif ?> BUT2 - Semestre 4</a></div>
                <div><a href="?controller=enseignant&action=accueil_enseignant2&niveau=3"><?php if (isset($_GET["niveau"]) && $_GET["niveau"]==3) : ?>>><?php endif ?> BUT3 - Semestre 6</a></div>
            <div class="card-body">
              <div class="container">
				...
				<tbody>
                    ...
                    <?php foreach(array_reverse($annees_promo) as $v):?>
                        ...
                        <?php foreach($stages[$v] as $infos):?>
                            <tr>
                            <div>
                                <th scope="row"><a href='?controller=enseignant&action=stage_etudiant&student_id=<?= e($infos['Student_ID'])?>&stage_id=<?= e($infos['Stage_ID'])?>&annee=<?= $v?>&niveau=<?= e($_GET['niveau'])?>'>Stage de <?= e($infos['Nom'])?></a></th>
